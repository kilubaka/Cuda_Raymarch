...
class SmOpUnion : virtual public SmoothOperation
{
public:
	...
	__device__ SmOpUnion(float p_1, float p_2)
	{
	...
	__device__ SmOpUnion(float p_1, float p_2, float s)
	{
		this->setPrimitive_1(p_1);
		this->setPrimitive_2(p_2);
		this->setSmooth(s);
